...
class GeneratedConverter
{
    ...
    /**
     * Convert MovStmt to AssignmentNode
     */
    private function convertMovStmt(array $data): \PESM\Parser\AST\AssignmentNode
    {
    ...
    /**
     * Convert AddStmt to AssignmentNode
     */
    private function convertAddStmt(array $data): \PESM\Parser\AST\AssignmentNode
    {
        $args = $this->extractArguments($data);
        return new \PESM\Parser\AST\AssignmentNode(...$args);
    }
    ...
    /**
     * Convert SubStmt to AssignmentNode
     */
    private function convertSubStmt(array $data): \PESM\Parser\AST\AssignmentNode
    {
        $args = $this->extractArguments($data);
        return new \PESM\Parser\AST\AssignmentNode(...$args);
    }
    ...
    /**
     * Convert MulStmt to AssignmentNode
     */
    private function convertMulStmt(array $data): \PESM\Parser\AST\AssignmentNode
    {
        $args = $this->extractArguments($data);
        return new \PESM\Parser\AST\AssignmentNode(...$args);
    }
    ...
    /**
     * Convert JmpStmt to GotoNode
     */
    private function convertJmpStmt(array $data): \PESM\Parser\AST\GotoNode
    {
        $args = $this->extractArguments($data);
        return new \PESM\Parser\AST\GotoNode(...$args);
    }

    /**
     * Convert JeStmt to IfNode
     */
    private function convertJeStmt(array $data): \PESM\Parser\AST\IfNode
    {
        $args = $this->extractArguments($data);
    ...
    /**
     * Convert JneStmt to IfNode
     */
    private function convertJneStmt(array $data): \PESM\Parser\AST\IfNode
    {
        $args = $this->extractArguments($data);
        return new \PESM\Parser\AST\IfNode(...$args);
    }
    ...
    /**
     * Convert JgStmt to IfNode
     */
    private function convertJgStmt(array $data): \PESM\Parser\AST\IfNode
    {
        $args = $this->extractArguments($data);
        return new \PESM\Parser\AST\IfNode(...$args);
    }
    ...
    /**
     * Convert OutStmt to InterruptNode
     */
    private function convertOutStmt(array $data): \PESM\Parser\AST\InterruptNode
    {
        $args = $this->extractArguments($data);
