...
class GeneratedConverter
{
    ...
    /**
     * Convert DoLoop to ForeachNode
     */
    private function convertDoLoop(array $data): \PESM\Parser\AST\ForeachNode
    {
        $args = $this->extractArguments($data);
    ...
    /**
     * Convert WriteStmt to InterruptNode
     */
    private function convertWriteStmt(array $data): \PESM\Parser\AST\InterruptNode
    {
        $args = $this->extractArguments($data);
