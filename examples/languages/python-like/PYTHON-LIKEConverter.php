...
class GeneratedConverter
{
    ...
    /**
     * Convert DictLiteral to ObjectLiteralNode
     */
    private function convertDictLiteral(array $data): \PESM\Parser\AST\ObjectLiteralNode
    {
        $args = $this->extractArguments($data);
        return new \PESM\Parser\AST\ObjectLiteralNode(...$args);
    }
