...
/* Keyword: ("WHILE" | "FUNCTION" | "RETURN" | "FOREACH" | "MESSAGE" | "ACCEPT" | "REFUSE" | "ELSE" | "AND" | "OR" | "NOT" | "END" | "IF" | "TO") !(/[a-zA-Z0-9_]/) */
...
function match_Keyword($stack = []) {
	...
	do {
		...
		while(\false);
		if($_331 === \false) { $_336 = \false; break; }
		$res_335 = $result;
		$pos_335 = $this->pos;
		$_334 = \null;
		do {
